...
export function CashIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
...
export function LendIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function TransferIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PieChartIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
// Section icon component that returns the appropriate icon based on section type
export function SectionIcon({ 
  section, 
  className = '', 
  size = 24 
}: { 
  section: 'cash' | 'bank' | 'mobile' | 'lend'; 
  className?: string; 
  size?: number;
}) {
  switch (section) {
    ...
    case 'bank':
      return <BankIcon className={className} size={size} />;
    case 'mobile':
      return <MobileIcon className={className} size={size} />;
    case 'lend':
      return <LendIcon className={className} size={size} />;
    default:
...
export function PanelLeftCloseIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PanelLeftOpenIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function FileSpreadsheetIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
